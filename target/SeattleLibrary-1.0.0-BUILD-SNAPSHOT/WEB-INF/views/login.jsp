...
<body>
	<div class="wrapper">
		...
		<div class="authorization">
			...
			<label class="authorization_text">パスワードをお忘れの方</label> <a
				class="authorization_link marker"
				href="<%=request.getContextPath()%>/resetPassword">パスワードリセット</a>
		</div>
		<footer>
			<div class="copyright">© 2019 Seattle Consulting Co., Ltd. All
				rights reserved.</div>
		</footer>
	</div>
</body>
